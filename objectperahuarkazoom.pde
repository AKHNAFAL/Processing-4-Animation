class objectperahuarkazoom {
  ...
  objectperahuarkazoom(float x, float y) {
    this.x = x;
    this.y = y;
    this.vx = 0;
    this.vy = 0;
...
ellipse(150, 121, 20, 20); // Kepala

// Menggambar tubuh stickman
stroke(0); // Warna hitam untuk garis
line(150, 133, 150, 163); // Tubuh (garis lurus)

// Menggambar lengan stickman
line(150, 133, 170, 153); // Lengan kanan
line(150, 133, 130, 153); // Lengan kiri

// Menggambar kepala
fill(255, 224, 189); // Warna kulit
ellipse(150, 120, 20, 20); // Kepala

// Menggambar topi nelayan
fill(57, 57, 57); // Warna merah untuk topi nelayan
beginShape();
vertex(140, 111);
bezierVertex(135, 108, 165, 108, 160, 111); // Lengkungan atas topi
bezierVertex(155, 120, 145, 120, 140, 111); // Lengkungan bawah topi
endShape(CLOSE);

// Menggambar mata
fill(0); // Warna hitam untuk mata
ellipse(145, 121, 5, 5); // Mata kiri (lebih besar)
ellipse(155, 121, 5, 5); // Mata kanan (lebih besar)

// Menggambar mulut untuk ekspresi kaget
noFill();
stroke(0);
beginShape();
vertex(143, 130);
bezierVertex(145, 133, 155, 133, 157, 130);
endShape();
